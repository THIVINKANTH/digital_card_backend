<nav class="navbar navbar-expand-sm ">
    <div class="container-fluid ">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
            ...
            <li class="nav-item ms-xl-5 ms-lg-4 ms-md-2 ms-5 me-xl-5 me-lg-0 me-md-0 me-0">
            ...
            <li class="nav-item ms-xl-5 ms-lg-4 ms-md-2 ms-5 " >
            ...
            <li class="nav-item dropdown ms-xl-5 ms-lg-4 ms-md-2 ms-5 d-flex">
                ...
                <ul class="dropdown-menu mt-3 me-lg-0 me-5" style="position: absolute;">
