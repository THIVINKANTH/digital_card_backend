...
<body >
    ...
    <div class="container-fluid home-section">
        <div class="row justify-content-center">
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-10 mt-5">
                                ...
                                <div class="col-xs-5 col-sm-5 col-md-7 col-lg-7">
                                    <div class="card ms-5" id="card-3">
                                        ...
                                        <div class="text-start ms-4 my-3">
                                            <h5 class="nme">{{ $names->first_name }} {{ $names->middle_name }} .{{ $names->last_name }}</h5>
                                            <h6 class="rle">{{ $names->desgination }}</h6>
                                        </div>
                                        <div class="row justify-content-center">
                                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                <?php
                                                    $social = json_decode($names->social_media_links,true);
